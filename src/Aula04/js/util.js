...
function initCamera(initialPosition) {
    var position = (initialPosition !== undefined) ? initialPosition : new THREE.Vector3(-50, 90, 50);
...
function addHouseAndTree(scene) {
    ...
    createPredio(scene, 0x00000, -15, 10, -15, 8, 20, 8,4.1);
    createPredio(scene, 0xffaf, 0, 10, -15, 8, 20, 8,4.1);
    createPredio(scene, 0xffff, 15, 10, -15, 8, 20, 8,4.1);
    createPredio(scene, 0xffffff, 30, 10, -15, 10, 20, 8,4.1);


    createPredio(scene, 0x55a5, -15, 10, 15, 8, 20, 8,-4.1);
    createPredio(scene, 0xff45, 0, 10, 15, 8, 20, 8,-4.1);
    createPredio(scene, 0xaaa4566, 18, 10, 18, 15, 20, 14,-7.1);
    createPredio(scene, 0xeeef46, 35, 10, 15, 8, 20, 8,-4.1);
;
    ...
    function createGroundPlane(scene) {
        ...
        var planeGeometry2 = new THREE.PlaneGeometry(70, 20);
    ...
    function createPredio(scene, cor, x, y, z, width, heigth, depth,zJanela) {
        var predio = new THREE.BoxBufferGeometry(width, heigth, depth);

        var predioMesh = new THREE.Mesh(predio, new THREE.MeshPhongMaterial({
            color: cor
        }));
        ...
        var geometryPorta = new THREE.PlaneBufferGeometry(4, 5, 32);
        var materialPorta = new THREE.MeshBasicMaterial({ color: 0x964b00, side: THREE.DoubleSide });
        var porta = new THREE.Mesh(geometryPorta, materialPorta);
        porta.position.set(0, -7, zJanela);


        var geometryjanela = new THREE.PlaneBufferGeometry(5, 3, 32);
        var materialJanela = new THREE.MeshBasicMaterial({ color: 0xffff00, side: THREE.DoubleSide });
        var janela = new THREE.Mesh(geometryjanela, materialJanela);
        janela.position.set(0, -1, zJanela);
        var janela2 = new THREE.Mesh(geometryjanela, materialJanela);
        janela2.position.set(0,3, zJanela);    
         var janela3 = new THREE.Mesh(geometryjanela, materialJanela);
        janela3.position.set(0,7, zJanela);
